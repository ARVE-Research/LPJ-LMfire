...
function fBexp(clay,sand,rock,sorg)
...
real(sp), intent(in) :: clay   ! soil clay concent (mass percent)
real(sp), intent(in) :: sand   ! soil sand concent (mass percent)
real(sp), intent(in) :: rock   ! soil rock concent (mass fraction)
real(sp), intent(in) :: sorg   ! soil organic matter content (mass percent)

real(sp) :: silt   ! soil silt concent (percent)
