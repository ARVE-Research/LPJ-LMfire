...
subroutine mtrm(pet,aet,elev,lat,anpp,livebiomass,whc,mtemp,mprec,soilm,pd)

! Minimalist Terrestrial Resource Model (MTRM) developed by Binford (2001)
! Kristen Krumhardt & Jed Kaplan 04.2012

! NB this code should be corrected! (03.2024)
